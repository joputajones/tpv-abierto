...
|---|---|---:|---:|---:|---|---|---|
| R-001 | FloCafe baseline is less mature than its interface and README suggest | 4 | 5 | 20 | Windows portability, fail-closed premigration safety, restart recovery, automated cross-runner restore and `SIM/CI` offline operation are integrated; all 69 scripts and the post-merge four-platform matrix pass at `a6724c56`. M0 remains `IN_PROGRESS` pending a separate human exit decision and without restaurant-readiness evidence | [joputajones / #15](https://github.com/joputajones/tpv-abierto/issues/15) / [#30](https://github.com/joputajones/tpv-abierto/issues/30) / M0 | `IN_PROGRESS` |
...
| R-011 | Restaurant network or hardware failures are blamed on the software | 5 | 4 | 20 | Restart/WAL, cross-runner backup and #40 offline `SIM/CI` evidence are integrated, including the post-merge Ubuntu/Windows/macOS x64/arm64 matrix. #34 closed with a successful but technically incomplete second-operator restore. Hardware, hostile LAN, physical Internet/power loss, long-duration service and an accessible recovery assistant (#39) remain unavailable | [#34](https://github.com/joputajones/tpv-abierto/issues/34) / [#39](https://github.com/joputajones/tpv-abierto/issues/39) / [#40](https://github.com/joputajones/tpv-abierto/issues/40) / M1 | `PARTIAL` |
