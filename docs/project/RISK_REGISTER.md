...
| R-022 | Windows installation and recovery are not reproducible | 4 | 5 | 20 | SDK/MSVC repair and native rebuild are complete; PR #21 has integrated current `main` and validates Node-based install/test paths without Bash, but awaits CI and merge. This does not prove off-device restore or disaster recovery | [joputajones / #18](https://github.com/joputajones/tpv-abierto/issues/18) / M0 | `PARTIAL` |
