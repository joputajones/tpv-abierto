...
|---|---|---:|---:|---:|---|---|---|
| R-001 | FloCafe baseline is less mature than its interface and README suggest | 4 | 5 | 20 | Windows portability, fail-closed premigration safety, restart recovery and automated cross-runner restore are integrated; all 68 scripts pass in the full platform matrix. M0 remains `IN_PROGRESS` pending a separate human exit decision and without restaurant-readiness evidence | [joputajones / #15](https://github.com/joputajones/tpv-abierto/issues/15) / [#30](https://github.com/joputajones/tpv-abierto/issues/30) / M0 | `IN_PROGRESS` |
...
| R-011 | Restaurant network or hardware failures are blamed on the software | 5 | 4 | 20 | Restart/WAL and cross-runner backup evidence are integrated. #34 closed with a successful but technically incomplete second-operator restore; #40 has provisional local offline evidence. Hardware, hostile LAN, physical Internet/power loss and an accessible recovery assistant (#39) remain unavailable | [#34](https://github.com/joputajones/tpv-abierto/issues/34) / [#39](https://github.com/joputajones/tpv-abierto/issues/39) / [#40](https://github.com/joputajones/tpv-abierto/issues/40) / M1 | `PARTIAL` |
...
| R-020 | First-run telemetry may start before affirmative consent | 3 | 4 | 12 | `PARTIAL`: the #40 branch changes fresh-install consent/telemetry defaults to `false`; O-01/O-10 prove zero attempts before or without consent and O-11 covers the consented failure path. Merge/CI and an unambiguous frontend opt-in remain pending | Privacy owner / M1 / [#40](https://github.com/joputajones/tpv-abierto/issues/40) | `PARTIAL` |
