...
|---|---|---:|---:|---:|---|---|---|
| R-001 | FloCafe baseline is less mature than its interface and README suggest | 4 | 5 | 20 | Windows portability, fail-closed premigration safety and PR #31's controlled restart matrix are integrated; all 67 scripts pass on Windows/Linux. M0 remains `IN_PROGRESS` pending a separate human exit decision and without restaurant-readiness evidence | [joputajones / #15](https://github.com/joputajones/tpv-abierto/issues/15) / [#30](https://github.com/joputajones/tpv-abierto/issues/30) / M0 | `IN_PROGRESS` |
