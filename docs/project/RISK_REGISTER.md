...
| R-011 | Restaurant network or hardware failures are blamed on the software | 5 | 4 | 20 | The #39 branch adds an accessible graphical checker with isolated restore and local A-01…A-16 evidence. Merge, cross-platform CI and a real non-technical run are pending; hardware, hostile LAN, physical Internet/power loss and long-duration service also remain unverified | [#34](https://github.com/joputajones/tpv-abierto/issues/34) / [#39](https://github.com/joputajones/tpv-abierto/issues/39) / [#40](https://github.com/joputajones/tpv-abierto/issues/40) / M1 | `PARTIAL` |
