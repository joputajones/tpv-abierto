...
|---|---|---:|---:|---:|---|---|---|
| R-001 | FloCafe baseline is less mature than its interface and README suggest | 4 | 5 | 20 | PR #14 is merged and #15 is closed; Windows portability is integrated, but M0 remains open because migration safety and controlled restart evidence are incomplete | [joputajones / #15](https://github.com/joputajones/tpv-abierto/issues/15) / M0 | `IN_PROGRESS` |
...
| R-005 | Updates or migrations damage an existing restaurant database | 3 | 5 | 15 | PR branch adds a verified fail-closed barrier before pending migrations and proves source invariants plus isolated synthetic retry; #16 remains open pending merge, historical migrations remain immutable and external recovery is not proved | [joputajones / #16](https://github.com/joputajones/tpv-abierto/issues/16) / M0 | `PARTIAL` |
...
| R-022 | Windows installation and recovery are not reproducible | 4 | 5 | 20 | `DONE` 2026-07-31 for development portability: PR #21 merged at `a51fa54`; post-merge `main` passes clean install, native rebuild, Electron verification, builds, upgrade fixture and all 65 tests without Bash. Off-device restore, hardware and disaster recovery remain covered by R-005/R-011, not this closure | [joputajones / #18](https://github.com/joputajones/tpv-abierto/issues/18) / M0 | `DONE` |
