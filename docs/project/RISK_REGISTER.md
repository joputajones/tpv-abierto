...
|---|---|---:|---:|---:|---|---|---|
| R-001 | FloCafe baseline is less mature than its interface and README suggest | 4 | 5 | 20 | PR #14 is merged and #15 is closed; M0 remains open because portability integration, migration safety and physical/operational evidence are incomplete | [joputajones / #15](https://github.com/joputajones/tpv-abierto/issues/15) / M0 | `IN_PROGRESS` |
...
| R-022 | Windows installation and recovery are not reproducible | 4 | 5 | 20 | SDK/MSVC repair and native rebuild are complete; after integrating current `main`, PR #21 passes the Node-based install/test paths without Bash and proves fail-fast error propagation, but awaits CI and merge. This does not prove off-device restore or disaster recovery | [joputajones / #18](https://github.com/joputajones/tpv-abierto/issues/18) / M0 | `PARTIAL` |
