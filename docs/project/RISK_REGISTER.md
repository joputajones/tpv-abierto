...
|---|---|---:|---:|---:|---|---|---|
| R-001 | FloCafe baseline is less mature than its interface and README suggest | 4 | 5 | 20 | PR #14 is merged and #15 is closed; Windows portability and fail-closed premigration safety are integrated. #30 branch passes the controlled restart matrix locally, but review, Linux CI and merge remain before M0 reevaluation | [joputajones / #15](https://github.com/joputajones/tpv-abierto/issues/15) / [#30](https://github.com/joputajones/tpv-abierto/issues/30) / M0 | `IN_PROGRESS` |
...
| R-011 | Restaurant network or hardware failures are blamed on the software | 5 | 4 | 20 | Health endpoints exist; #30 branch simulates local process restart and port reuse only. Physical power loss, off-device restore and representative hardware/LAN failure campaigns remain unavailable | Operations owner / M1 | `BLOCKED` |
